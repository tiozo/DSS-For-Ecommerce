...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> uploadSales(@RequestParam("file") MultipartFile file) {
        try {
            ...
            log.info("[DEBUG - PIPELINE] Uploaded {} sales records. Triggering Rule Engine...", count);
            List<DecisionInsightEntity> insights = salesRuleEngine.processRules();
            log.info("[DEBUG - PIPELINE] Rule Engine completed. Insights generated: {}", insights.size());
